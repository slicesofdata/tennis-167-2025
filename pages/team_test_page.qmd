...
source(here::here("data", "processed", "cleaned_mpg.Rds"))

# read cleaned and plot data
source(here::here("src", "figs", "plot_cty_hwy_mpg_point.png"))
...
```{r}
stopifnot(fs::file_exists(here::here("src", "figs", "plot_cty_hwy_mpg_point.png")))
knitr::include_graphics(here::here("figs", "plot_cty_hwy_mpg_point.png"))
```
